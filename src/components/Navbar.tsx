      ...
      >
        ...
        >
          ...
          <div className="flex items-center shrink-0" style={{ gap: 'clamp(24px, 2.5vw, 48px)' }}>
            <Link to="/my-projects" aria-label="Мои проекты" className="cursor-pointer flex items-center justify-center bg-transparent border-none p-0 hover:opacity-70 transition-opacity" style={{ width: 'clamp(16px, 1.39vw, 27px)', height: 'clamp(16px, 1.39vw, 27px)' }}>
