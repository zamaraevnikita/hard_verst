      ...
      <main className="flex flex-col w-full mx-auto page-container font-['Inter'] relative text-black items-center self-center">
        ...
        <section 
          ...
          style={{ 
            ...
            paddingTop: 'clamp(80px, 9.375vw, 150px)',
        ...
        >
          ...
          >
            ...
            <h1 
              ...
              style={{
                fontWeight: 400,
                fontSize: 'clamp(14px, 1.389vw, 26px)',
                lineHeight: '1.2',
            ...
            {/* Количество страниц */}
              <div>
                <p style={{ fontSize: 'clamp(10px, 0.903vw, 15px)', color: '#000', marginBottom: '8px' }}>
                  Количество страниц
                </p>
                {/* Number selector row */}
              ...
              <div>
                <p style={{ fontSize: 'clamp(10px, 0.903vw, 15px)', color: '#000', marginBottom: '4px' }}>
                  Идеальное кол-во фото
                </p>
                <p style={{ fontSize: 'clamp(12px, 1.25vw, 20px)' }}>От 16 до 26</p>
              </div>
              ...
              <div>
                ...
                <p style={{ fontSize: 'clamp(14px, 1.25vw, 20px)' }}>210*297 мм</p>
              </div>
              ...
              <div>
                ...
                <div className="flex w-full" style={{ gap: '10px' }}>
                  <button
                    ...
                    style={{
                      maxWidth: 'clamp(100px, 10vw, 150px)',
              ...
              <div>
                ...
                <p style={{ fontSize: 'clamp(12px, 1.25vw, 20px)', lineHeight: '1.2' }}>
            ...
            >
              ...
              >
                <span style={{ fontSize: 'clamp(11px, 1vw, 16px)' }}>Собрать в конструкторе</span>
                <span style={{ fontSize: 'clamp(13px, 1.2vw, 18px)', fontWeight: 'bold' }}>3000 ₽</span>
              </Link>
              <Link
                to="/designer-service"
                className="flex flex-col flex-1 justify-center items-center transition-opacity hover:opacity-80 text-center"
              ...
              >
                <span style={{ fontSize: 'clamp(11px, 1vw, 16px)' }}>Сделать заказ дизайнеру</span>
                <span style={{ fontSize: 'clamp(8px, 0.7vw, 11px)', color: '#737373' }}>(персональная сборка)</span>
                <span style={{ fontSize: 'clamp(13px, 1.2vw, 18px)', fontWeight: 'bold' }}>6500 ₽</span>
              </Link>
            </div>
        ...
        <section 
          className="grid w-full"
          style={{ 
            gridTemplateColumns: 'clamp(120px, 22.222vw, 500px) clamp(250px, 62.152vw, 1200px)',
            justifyContent: 'center',
            marginTop: 'clamp(30px, 5vw, 75px)',
            gap: 'clamp(30px, 4.93vw, 95px)'
          }}
        >
          ...
          <div className="flex flex-col w-full">
            <h3 
              ...
              style={{
                fontSize: 'clamp(11px, 0.972vw, 16px)',
            ...
            <div 
              ...
              style={{ padding: 'clamp(15px, 2vw, 25px)' }}
            >
               ...
               <div className="flex w-full" style={{ gap: '10px' }}>
                 <button 
                   ...
                   style={{ height: 'clamp(30px, 3vw, 45px)', fontSize: 'clamp(11px, 0.9vw, 14px)' }}
                 >
                   Самовывоз
                 </button>
                 <button 
                   onClick={() => {
                     ...
                     setDeliveryType('sdek'); // force SDEK when Courier is selected
                   }}
               ...
               <div className="flex w-full justify-center">
                 <div className="flex justify-center items-center border-b border-black w-full" style={{ paddingBottom: '6px' }}>
                    <span style={{ fontSize: 'clamp(11px, 0.9vw, 14px)' }} className="flex items-center gap-2 cursor-pointer">
                      Москва 
               ...
               <div className={`flex w-full ${deliveryOption === 'courier' ? 'justify-center' : 'justify-between'}`} style={{ gap: 'clamp(10px, 2vw, 20px)' }}>
                 {deliveryOption === 'pickup' && (
                   <button 
                     ...
                     style={{ height: 'clamp(35px, 3vw, 50px)' }}
                   >
               ...
               <div className="flex flex-col">
                 <p style={{ fontSize: 'clamp(11px, 0.95vw, 15px)', color: '#000', marginBottom: '2px' }}>
                   Доставка до 3х дней
                 </p>
                 <p style={{ fontSize: 'clamp(9px, 0.77vw, 12px)', color: '#989797', lineHeight: '1.2', marginBottom: 'clamp(10px, 1.5vw, 20px)' }}>
                   Отправляем заказы день в день, либо на следующий
                   <br />
                   день после готовности в печати.
                 </p>
                 <p style={{ fontSize: 'clamp(11px, 0.95vw, 15px)', color: '#000' }}>
                   Стоимость: 230₽
                 </p>
               </div>
            </div>
          ...
          <div className="flex flex-col w-full h-full">
            ...
            >
              {/* ПЕЧАТЬ */}
              <div className="flex flex-col flex-1 w-1/2" style={{ paddingRight: 'clamp(5px, 1vw, 20px)' }}>
                <h2 
                  className="font-['Syncopate'] uppercase"
                  style={{ fontSize: 'clamp(11px, 0.972vw, 16px)', marginBottom: 'clamp(15px, 1.5vw, 25px)' }}
                >
                  ПЕЧАТЬ
                </h2>
                <p style={{ fontSize: 'clamp(10px, 0.9vw, 13px)', lineHeight: '1.4' }}>
              ...
              {/* ДОСТАВКА */}
              <div className="flex flex-col flex-1 w-1/2" style={{ paddingLeft: 'clamp(5px, 1vw, 20px)' }}>
                <h2 
                  className="font-['Syncopate'] uppercase"
                  style={{ fontSize: 'clamp(11px, 0.972vw, 16px)', marginBottom: 'clamp(15px, 1.5vw, 25px)' }}
                >
                ...
                <div style={{ fontSize: 'clamp(10px, 0.9vw, 13px)', lineHeight: '1.4' }}>
                  <ul style={{ listStyleType: 'disc', paddingLeft: '18px', marginBottom: 'clamp(15px, 1.5vw, 25px)' }}>
                  ...
                  <div style={{ marginBottom: 'clamp(15px, 1.5vw, 25px)' }}>
        ...
        >
          <h2 
            ...
            style={{ 
              fontSize: 'clamp(16px, 1.944vw, 36px)',
          ...
          <div className="flex flex-col" style={{ gap: 'clamp(12px, 1.5vw, 20px)' }}>
            ...
            >
              <span className="font-['Inter']" style={{ fontSize: 'clamp(11px, 0.9vw, 14px)' }}>Написать в Telegram</span>
            </Link>
            <Link 
              to="#" 
              className="bg-white border border-black flex justify-center items-center transition-all hover:bg-black hover:text-white"
            ...
            >
              <span className="font-['Inter']" style={{ fontSize: 'clamp(11px, 0.9vw, 14px)' }}>Написать во ВКонтакте</span>
            </Link>
          </div>
        </section>
